package com.droiduino.bluetoothconn.draw.activity
...
class DrawingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        filter.addAction("DrawingActivitySendColor")
    ...
    private val mBroadcastReceiver: BroadcastReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent?) {
            ...
            when(intent?.getIntExtra("color", 1)) {
                 1 -> image_color_black.performClick()
                 2 -> image_color_red.performClick()
                3 -> image_color_blue.performClick()
                4 -> image_color_yellow.performClick()
                else -> image_color_black.performClick()
            }
        }
    }
